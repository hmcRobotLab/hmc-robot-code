...
def drawCircles():
    cv.Circle(D["image"], D["head"], 10, \
                      cv.RGB(100, 100, 100), thickness=1, lineType=8, shift=0)
    cv.Circle(D["image"], (D["hand"]["left"]["x"],D["hand"]["left"]["y"]), D["hand"]["left"]["size"], \
                      cv.RGB(125, 125, 125), thickness=1, lineType=8, shift=0)
    cv.Circle(D["image"], (D["hand"]["right"]["x"],D["hand"]["right"]["y"]), D["hand"]["right"]["size"], \
                      cv.RGB(125, 125, 125), thickness=1, lineType=8, shift=0)
##    cv.Circle(D["image"], (D["elbow"]["left"]["x"],D["elbow"]["left"]["y"]), 10, \
##                      cv.RGB(180, 180, 180), thickness=1, lineType=8, shift=0)
##    cv.Circle(D["image"], (D["elbow"]["right"]["x"],D["elbow"]["right"]["y"]), 10, \
##                      cv.RGB(180, 180, 180), thickness=1, lineType=8, shift=0)
    cv.Circle(D["image"], (D["shoulder"]["left"]["x"],D["shoulder"]["left"]["y"]), 10, \
