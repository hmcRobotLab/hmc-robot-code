...
def handle_sensor_data( data ):
    ...
    elif data.bumpRight == True:
        print 'Bumping something on the right! Going backwards...'
        tank(-50,-50)
        print 'Going backwards for two seconds'
        tank(0,-50)
        rospy.sleep(random.uniform(0,3))
        print 'PASSED'

    elif data.bumpLeft == True:
        print 'Bumping something on the left! Going backwards...'
        tank(-50,-50)
        print 'Going backwards for two seconds'
        tank(0,-50)
        rospy.sleep(random.uniform(0,3))
