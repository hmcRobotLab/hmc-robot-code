...
############################################
# 
# Code to run wall following on right 
# Needs to have no walls on left or it might get distracted
# needs:
#   roscore
#   connect to roomba
#   roomba drivers
...
def state_wall_wait( timer_event = None ):
    ...
    print data.cliffFrontRightSignal
    if data.cliffFrontRightSignal > 400:
