...
#Generic Imports
import roslib; roslib.load_manifest('image_thresholder')
...
#  Testing: "static_image"
#  Drone: "ardrone2/camera/image"
...
class ImageProcessor:
  ...
  def process_section(self):
    ...
    # No9yyw set sliders to those values
  ...
  def mouse_section(self):
    ...
    if self.mouse_down:
      ...
      x1 = self.up_coord[0]
      y1 = self.up_coord[1]
      cv.PolyLine(self.image, [[(x0,y0), (x0,y1), (x1,y1), (x1,y0)]], 1, cv.RGB(255, 255, 0))
