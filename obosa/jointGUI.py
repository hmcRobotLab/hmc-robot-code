...
Esc (exit) </font></center><br>")
    ...
    def keyPressEvent(self, e):
        ...
        if char == 'i': #If 'W' is pressed, then tell the robot to move forward
            robot.keyboardControl("Forward")
            return

        if char == 'k': #If 'S' is pressed, then tell the robot to move backward
            robot.keyboardControl("Reverse")
            return

        if char == 'l': #If 'D' is pressed, then tell the robot to rotate clockwise
            robot.keyboardControl("Right")
            return

        if char == 'j': #If 'A' is pressed, then tell the robot to rotate counter-clockwise
            robot.keyboardControl("Left")
            return

        if char == 'm':
            robot.keyboardControl("Brake")
            return

        if char == 'o':
            robot.keyboardControl("SlowDown")
            return

        if char == 'u':
            robot.keyboardControl("SpeedUp")
            return
